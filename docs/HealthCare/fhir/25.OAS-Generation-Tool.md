...
yaml_file=$(echo oas/*.yaml) && cp -f $yaml_file ImplementationGuide/opennz.org/${yaml_file##*/} && \
json_file=$(echo oas/*.json) && cp -f $json_file ImplementationGuide/opennz.org/${json_file##*/}
```
